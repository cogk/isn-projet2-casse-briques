...
# On crée les boutons
B1 = Button(fen, text='Jouer', command=jouer)
B1.place(x=largeur_jeu + 20,y=590)
...
balle_vitesse_y_initiale = 0
balle_vitesse_x = 0
balle_vitesse_y = balle_vitesse_y_initiale


balle = fond.create_oval(balle_x_initial,balle_y_initial, balle_x_initial,balle_y_initial, fill='#9c27b0',width=balle_rayon)
...
def déplacer_balle(dt):
    global balle_vitesse_x, balle_vitesse_y, hauteur_jeu, largeur_jeu, balle_rayon
    ...
    if (barre_x1 - balle_rayon/2 < x < barre_x2 + balle_rayon/2) and (barre_y1 - balle_rayon/2 < y < barre_y2):
        balle_vitesse_y =-balle_vitesse_y + cos (1)
